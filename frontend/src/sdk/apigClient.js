...
apigClientFactory.newClient = function (config) {
    ...
    apigClient.searchLocationGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['sort_field', 'location', 'user_input'], ['body']);
        ...
        var searchLocationGetRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['sort_field', 'user_input']),
            body: body
        };
